CREATE VIEW `variant-finance-data-project.MS_ad_spend_data.MS_Merged_Spend_View`
AS SELECT * FROM `variant-finance-data-project.MS_ad_spend_data.MS_Ads_final_spend_CL`
UNION ALL
