CREATE OR REPLACE VIEW `variant-finance-data-project.MS_ad_spend_data.MS_Ads_final_spend_PD` AS
...
ad_performance_with_countries AS (
  ...
  FROM `variant-finance-data-project.MS_ad_spend_data.MS_Ads_PD_AdPerformanceDailyReport` ad
...
SELECT 
  ...
  COALESCE(fem.`App_name`, 'PD') as App_name,
  CASE 
