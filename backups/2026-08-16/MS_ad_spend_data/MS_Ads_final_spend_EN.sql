CREATE OR REPLACE VIEW `variant-finance-data-project.MS_ad_spend_data.MS_Ads_final_spend_EN` AS
...
ad_performance_with_countries AS (
  ...
  FROM `variant-finance-data-project.MS_ad_spend_data.MS_Ads_EN_AdPerformanceDailyReport` ad
...
SELECT 
  ...
  COALESCE(fem.`App_name`, 'EN') as App_name,
  CASE 
