CREATE PROCEDURE `variant-finance-data-project`.VPU.proc_Refund_Table()
BEGIN

-- =====================================================
-- REFUND TABLE CREATION SCRIPT - CORRECTED VERSION
-- Refund Analysis for Subscription Business Metrics
-- FIXES: Proper Country_Code separation for JP/Non-JP
-- MODIFICATION: Added refund ratio data quality filter
-- =====================================================

CREATE OR REPLACE TABLE `variant-finance-data-project.VPU.Refund_Table` AS
...
-- Table: variant-finance-data-project.VPU.Refund_Table
-- 
-- MODIFICATION SUMMARY:
-- ✅ Added refund_ratio_threshold = 0.20 to config
-- ✅ Added minimum_refund_count = 30 to config
-- ✅ Carried both variables through master_combinations
-- ✅ Applied data quality filter in final_calculations:
--    - If Refund_Ratio > 0.20 AND Refund_Count < 30, set Refund_Ratio = 0
--    - Otherwise, use calculated Refund_Ratio
-- ✅ No other changes made to existing logic
-- =====================================================
