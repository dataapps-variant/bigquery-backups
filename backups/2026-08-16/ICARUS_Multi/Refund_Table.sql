...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_Refund_Table`()
BEGIN
...
CREATE OR REPLACE TABLE `variant-finance-data-project.ICARUS_Multi.Refund_Table` AS
