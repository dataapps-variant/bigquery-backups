CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_7K_Crystal_Ball_App_level_24BC`()
BEGIN

CREATE OR REPLACE TABLE `variant-finance-data-project.ICARUS_Multi.7K_Crystal_Ball_App_level_24BC` AS
