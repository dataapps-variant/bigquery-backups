CREATE PROCEDURE `variant-finance-data-project`.ICARUS_Multi.proc_Active_Plans_6M()
BEGIN

CREATE OR REPLACE TABLE `variant-finance-data-project.ICARUS_Multi.Active_Plans_6M` AS
SELECT 
    App_Name,
