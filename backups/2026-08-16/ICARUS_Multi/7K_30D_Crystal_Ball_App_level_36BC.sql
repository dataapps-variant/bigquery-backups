CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_7K_30D_Crystal_Ball_App_level_36BC`()
BEGIN

CREATE OR REPLACE TABLE `variant-finance-data-project.ICARUS_Multi.7K_30D_Crystal_Ball_App_level_36BC` AS
...
app_base_aggregated AS (
  ...
  FROM `variant-finance-data-project.ICARUS_Multi.7K_30D_Crystal_Ball_36BC`
    ...
    CASE 
      ...
      WHEN rs24.Billing_Cycle = 25 THEN 
        CASE
          ...
          WHEN rs24.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs25.Billing_Cycle = 26 THEN 
        CASE
          ...
          WHEN rs25.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs26.Billing_Cycle = 27 THEN 
        CASE
          ...
          WHEN rs26.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs27.Billing_Cycle = 28 THEN 
        CASE
          ...
          WHEN rs27.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs28.Billing_Cycle = 29 THEN 
        CASE
          ...
          WHEN rs28.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs29.Billing_Cycle = 30 THEN 
        CASE
          ...
          WHEN rs29.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs30.Billing_Cycle = 31 THEN 
        CASE
          ...
          WHEN rs30.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs31.Billing_Cycle = 32 THEN 
        CASE
          ...
          WHEN rs31.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs32.Billing_Cycle = 33 THEN 
        CASE
          ...
          WHEN rs32.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs33.Billing_Cycle = 34 THEN 
        CASE
          ...
          WHEN rs33.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs34.Billing_Cycle = 35 THEN 
        CASE
          ...
          WHEN rs34.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs35.Billing_Cycle = 36 THEN 
        CASE
          ...
          WHEN rs35.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
...
final_calculations AS (
  SELECT 
    ...
    CASE 
      WHEN rs36.Retention_rate IS NULL THEN NULL
      ELSE COALESCE(
        SAFE_DIVIDE(rs36.CB_Value, NULLIF(rs36.CB_User, 0)) * rs36.Retention_rate,
        0.0
      ) + COALESCE(
    ...
    CASE 
      WHEN rs36.Retention_rate IS NULL THEN NULL
      ELSE COALESCE(
        SAFE_DIVIDE(rs36.CB_Value, NULLIF(rs36.CB_User, 0)) * (rs36.Retention_rate - rs36.Refund_ratio),
        0.0
      ) + COALESCE(
        SAFE_DIVIDE(rs36.Single_Sale_Value, NULLIF(rs36.Subscription_users, 0)),
        0.0
