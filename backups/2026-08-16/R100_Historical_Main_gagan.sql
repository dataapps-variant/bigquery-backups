CREATE OR REPLACE PROCEDURE `variant-finance-data-project.R100.R100_Historical_Main_Proc`()
BEGIN
CREATE OR REPLACE TABLE `variant-finance-data-project.R100.R100_Historical_Main_gagan`
