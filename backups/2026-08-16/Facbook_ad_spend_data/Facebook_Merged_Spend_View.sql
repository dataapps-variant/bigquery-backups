-- MERGED VIEW FOR ALL FACEBOOK APPS: CT, AT, JF
CREATE OR REPLACE VIEW `variant-finance-data-project.Facbook_ad_spend_data.Facebook_Merged_Spend_View` AS

-- Combine data from all three Facebook apps
SELECT * FROM (
