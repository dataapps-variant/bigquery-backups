CREATE OR REPLACE TABLE `variant-finance-data-project.LMC.CN_retention_data` AS
WITH 
...
base_data AS (
    -- Step 1: Direct CN retention data
    SELECT 
...
-- Filter to keep only records where first 2 letters of Cohort_Concat = "CN"
