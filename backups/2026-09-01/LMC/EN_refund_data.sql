CREATE OR REPLACE TABLE `variant-finance-data-project.LMC.EN_refund_data` AS
WITH 
...
-- Step 5: Filter to keep only records where first 2 letters of Cohort_Concat = "EN"
