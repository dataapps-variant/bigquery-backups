CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_Final_Table_Formatted_24BC`()
BEGIN
...
-- =====================================================
-- SOURCE: Icarus_Cohort.Final_Table_24BC
...
source_data AS (
  SELECT 
    ...
    Cohort,
    Table as Table_Type
  FROM `variant-finance-data-project.Icarus_Cohort.Final_Table_24BC`
),
