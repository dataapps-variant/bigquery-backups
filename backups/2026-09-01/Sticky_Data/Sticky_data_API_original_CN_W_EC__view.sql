CREATE VIEW `variant-finance-data-project.Sticky_Data.Sticky_data_API_original_CN_W_EC`
AS WITH 
...
IP_Parse AS (
  ...
  FROM variant-finance-data-project.Sticky_Data.Sticky_data_API_original_CN as CN
),
