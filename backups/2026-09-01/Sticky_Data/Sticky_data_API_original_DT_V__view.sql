CREATE VIEW `variant-finance-data-project.Sticky_Data.Sticky_data_API_original_DT_V`
AS WITH combined_data AS (
  ...
  SELECT
    ...
    cc_first_6 AS BIN
  FROM `variant-finance-data-project.Sticky_Data.Sticky_data_API_original_DT`
  ...
  SELECT
    ...
    prd_offer_id AS Offer_Id,
    cc_first_6 AS BIN
  FROM `variant-finance-data-project.Sticky_Data.Sticky_data_API_updated_DT`
...
UNION ALL
  ...
  SELECT
    ...
    prd_offer_id AS Offer_Id,
    cc_first_6 AS BIN
  FROM `variant-finance-data-project.Sticky_Data.Sticky_data_API_original_DT_Incremental`
