...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_Final_Table_24BC` ()
BEGIN


-- =====================================================
-- FINAL TABLE CREATION SCRIPT - ICARUS_COHORT (AFID LEVEL) - EXTENDED TO BC24
...
-- CHANGED FOR 24BC: sourced from the 4 IC_7K*_24BC tables (BC0-BC24)
-- =====================================================

CREATE OR REPLACE TABLE `variant-finance-data-project.Icarus_Cohort.Final_Table_24BC` AS
...
-- =====================================================
unioned_data AS (
  -- Table 1: IC_7K_30D_Crystal_Ball_24BC
  SELECT 
    Report_date,
    Product_Name_Final,
    Billing_Cycle,
  ...
  -- Table 2: IC_7K_Crystal_Ball_24BC
  SELECT 
    Report_date,
    Product_Name_Final,
    Billing_Cycle,
  ...
  -- Table 3: IC_7K_30D_Main_Table_24BC
  SELECT 
    Report_date,
    Product_Name_Final,
    Billing_Cycle,
...
-- =====================================================
-- SCRIPT COMPLETE - ICARUS_COHORT FINAL TABLE (FIXED) - EXTENDED TO BC24
-- Table: variant-finance-data-project.Icarus_Cohort.Final_Table_24BC
--
-- SOURCE TABLES:
-- 1. Icarus_Cohort.IC_7K_30D_Crystal_Ball_24BC (CB_User → Rebills_raw)
-- 2. Icarus_Cohort.IC_7K_Crystal_Ball_24BC (CB_User → Rebills_raw)
-- 3. Icarus_Cohort.IC_7K_30D_Main_Table_24BC (Rebill_users → Rebills_raw)
-- 4. Icarus_Cohort.IC_7K_Main_Table_24BC (Rebill_users → Rebills_raw)
--
-- OUTPUT: 25 columns (unchanged from BC12 version)
-- =====================================================
