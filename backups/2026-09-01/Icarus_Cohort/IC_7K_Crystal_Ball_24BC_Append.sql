-- =====================================================
-- IC_7K_Crystal_Ball_24BC — INCREMENTAL APPEND
-- Converted from proc_IC_7K_Crystal_Ball_24BC (full rebuild).
--
...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_IC_7K_Crystal_Ball_24BC_Append`()
BEGIN
  ...
  -- =====================================================
  DELETE FROM `variant-finance-data-project.Icarus_Cohort.IC_7K_Crystal_Ball_24BC`
  WHERE Report_date >= DATE_SUB(
    (SELECT MAX(Report_date) FROM `variant-finance-data-project.Icarus_Cohort.IC_7K_Crystal_Ball_24BC`),
  ...
  IF days_to_process > 0 THEN
    ...
    -- =====================================================
    INSERT INTO `variant-finance-data-project.Icarus_Cohort.IC_7K_Crystal_Ball_24BC` (
...
--   proc_IC_7K_Crystal_Ball_24BC_Append   <- this one
--
...
-- =====================================================
-- IC_7K_Crystal_Ball_24BC must already exist — run the rebuild once to seed
