-- =====================================================
-- IC REFUND TABLE — OPTIMIZED
-- Optimization of proc_IC_Refund_Table. Same structure as the other
...
--
-- CREATE OR REPLACE TABLE `variant-finance-data-project.Icarus_Cohort.IC_Refund_Table_backup`
-- AS SELECT * FROM `variant-finance-data-project.Icarus_Cohort.IC_Refund_Table`;
--
...
--   bq show --format=prettyjson variant-finance-data-project:Icarus_Cohort.IC_Refund_Table
--
...
--   WHERE routine_name = 'proc_IC_Refund_Table';
--
-- STEP 6 — Sanity check
...
-- FROM      `variant-finance-data-project.Icarus_Cohort.IC_Refund_Table`        n
-- FULL JOIN `variant-finance-data-project.Icarus_Cohort.IC_Refund_Table_backup` o
...
-- Keep IC_Refund_Table_backup for a few cycles before dropping it.
--
--
-- =====================================================
-- IF A RUN EVER FAILS
...
--
-- CREATE OR REPLACE TABLE `variant-finance-data-project.Icarus_Cohort.IC_Refund_Table`
-- PARTITION BY Report_date
-- CLUSTER BY Product_Name_Final, AFID, Country_Code, Billing_Cycle
-- AS SELECT * FROM `variant-finance-data-project.Icarus_Cohort.IC_Refund_Table_backup`;
--
--
-- =====================================================
-- DOWNSTREAM QUERIES
