CREATE PROCEDURE `variant-finance-data-project`.Icarus_Cohort.proc_IC_Refund_Table_AFID()
BEGIN


-- =====================================================
-- REFUND TABLE CREATION SCRIPT - V3 AFID_SUFFIX ONLY
-- Refund Analysis for Subscription Business Metrics
-- Table: Icarus_Cohort.IC_Refund_Table_AFID
