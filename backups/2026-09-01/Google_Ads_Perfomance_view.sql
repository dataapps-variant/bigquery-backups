CREATE OR REPLACE VIEW `variant-finance-data-project.vatiant_finance_Google_Query_Test.Google_Ads_final_spend` AS
SELECT 
...
FROM 
    `variant-finance-data-project.vatiant_finance_Google_Query_Test.ad_performance` ad
