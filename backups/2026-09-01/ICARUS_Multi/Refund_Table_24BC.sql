...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_Refund_Table_24BC`()
BEGIN


                              -- =====================================================
-- REFUND TABLE CREATION SCRIPT - MODIFIED VERSION
-- Refund Analysis for Subscription Business Metrics
-- MODIFICATIONS:
-- 1. Plan_List aggregation: First record by Trial_Price, AVG(Trial_Price)
-- 2. Product_Name_Final replaced with Product_Name_Final_Merged for transaction joins
-- 3. Currency filtering added on Sticky_data joins (eligible_transactions, all_customer_refunds)
-- 4. aggregated_output shows 'Multi' for plans with multiple currencies
-- =====================================================

CREATE OR REPLACE TABLE `variant-finance-data-project.ICARUS_Multi.Refund_Table_24BC` AS
