-- =====================================================
-- 7K_Main_Table_App_AFID_level_24BC — INCREMENTAL APPEND
-- Converted from proc_7K_Main_Table_App_AFID_level_24BC (full rebuild).
--
...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_7K_Main_Table_App_AFID_level_24BC_Append`()
BEGIN
  ...
  -- =====================================================
  DELETE FROM `variant-finance-data-project.ICARUS_Multi.7K_Main_Table_App_AFID_level_24BC`
  WHERE Report_date >= DATE_SUB(
    (SELECT MAX(Report_date) FROM `variant-finance-data-project.ICARUS_Multi.7K_Main_Table_App_AFID_level_24BC`),
  ...
  SET last_processed_date = (
    ...
    FROM `variant-finance-data-project.ICARUS_Multi.7K_Main_Table_App_AFID_level_24BC`
  );
  ...
  IF days_to_process > 0 THEN
    ...
    -- =====================================================
    INSERT INTO `variant-finance-data-project.ICARUS_Multi.7K_Main_Table_App_AFID_level_24BC` (
...
app_afid_base_aggregated AS (
  ...
  FROM `variant-finance-data-project.Icarus_Cohort.IC_7K_Main_Table_24BC`
...
--
-- 2. The gate resolves to NULL, not 0.0. IC_7K_Main_Table_24BC and
--    IC_7K_Crystal_Ball_24BC use 0.0 there, and their final_calculations
...
--
--   target : ICARUS_Multi.7K_Main_Table_App_AFID_level_24BC
--   source : Icarus_Cohort.IC_7K_Main_Table_24BC
...
--   proc_IC_7K_Main_Table_24BC_Append
--   proc_7K_Main_Table_App_AFID_level_24BC_Append   <- this one
--
...
--
-- Keep lookback_days aligned with IC_7K_Main_Table_24BC's, or restated days
...
-- FROM `variant-finance-data-project.Icarus_Cohort.IC_7K_Main_Table_24BC` s
