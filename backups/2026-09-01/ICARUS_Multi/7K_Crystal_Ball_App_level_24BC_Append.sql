CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_7K_Crystal_Ball_App_level_24BC_Append`()
BEGIN
-- =====================================================
...
-- =====================================================
DELETE FROM `variant-finance-data-project.ICARUS_Multi.7K_Crystal_Ball_App_level_24BC`
WHERE Report_date >= DATE_SUB(
  (SELECT MAX(Report_date) FROM `variant-finance-data-project.ICARUS_Multi.7K_Crystal_Ball_App_level_24BC`),  -- ▼ (2 of 4) ▼
...
SET last_processed_date = (
  ...
  FROM `variant-finance-data-project.ICARUS_Multi.7K_Crystal_Ball_App_level_24BC`
);
...
IF days_to_process > 0 THEN
  ...
  -- =====================================================
  INSERT INTO `variant-finance-data-project.ICARUS_Multi.7K_Crystal_Ball_App_level_24BC`
