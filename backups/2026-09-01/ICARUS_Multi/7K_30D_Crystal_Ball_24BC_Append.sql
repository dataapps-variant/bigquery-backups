...
-- =====================================================
DELETE FROM `variant-finance-data-project.ICARUS_Multi.7K_30D_Crystal_Ball_24BC`
WHERE Report_date >= DATE_SUB(
  (SELECT MAX(Report_date) FROM `variant-finance-data-project.ICARUS_Multi.7K_30D_Crystal_Ball_24BC`),  -- ▼ (2 of 4) ▼
...
SET last_processed_date = (
  ...
  FROM `variant-finance-data-project.ICARUS_Multi.7K_30D_Crystal_Ball_24BC`
);
...
IF days_to_process > 0 THEN
  ...
  -- =====================================================
  INSERT INTO `variant-finance-data-project.ICARUS_Multi.7K_30D_Crystal_Ball_24BC`
