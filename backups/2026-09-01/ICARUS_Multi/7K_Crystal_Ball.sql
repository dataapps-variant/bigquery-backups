...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_7K_Crystal_Ball`()
BEGIN


CREATE OR REPLACE TABLE `variant-finance-data-project.ICARUS_Multi.7K_Crystal_Ball` AS
