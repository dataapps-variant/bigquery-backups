CREATE PROCEDURE `variant-finance-data-project`.VPU_Merged.proc_15K_SOT_Ratio()
BEGIN
...
CREATE OR REPLACE TABLE `variant-finance-data-project.VPU_Merged.15K_SOT_Ratio` AS
