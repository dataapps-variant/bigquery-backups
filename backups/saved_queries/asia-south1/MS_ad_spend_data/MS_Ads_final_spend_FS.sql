CREATE OR REPLACE VIEW `variant-finance-data-project.MS_ad_spend_data.MS_Ads_final_spend_FS` AS
...
ad_performance_with_countries AS (
  ...
  FROM `variant-finance-data-project.MS_ad_spend_data.MS_Ads_FS_AdPerformanceDailyReport` ad
...
SELECT 
  ...
  COALESCE(fem.`App_name`, 'FS') as App_name,
  CASE 
