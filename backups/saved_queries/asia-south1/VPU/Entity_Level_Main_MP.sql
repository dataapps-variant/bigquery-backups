...
-- COMPLETE REWRITE FROM SCRATCH - FIXED CT LOGIC
-- =====================================================

CREATE OR REPLACE TABLE `variant-finance-data-project.VPU.Entity_Level_Main_MP` AS
...
recent_users_mp AS (
  SELECT 
    sdw.Report_date,
    sdw.App_Name,
    COUNT(DISTINCT CONCAT(base.Updated_Cust_ID, '|', base.Product_Name_Final)) AS Recent_Users_MP
  FROM spend_date_windows sdw
