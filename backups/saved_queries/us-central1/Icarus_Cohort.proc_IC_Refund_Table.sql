...
-- MODIFICATION 3: Added First_Date_of_Sale filter
-- =====================================================
...
-- MODIFICATION 3: Added First_Date_of_Sale filter ✅ EDIT 4
-- =====================================================
enriched_master AS (
  SELECT 
    mc.*,
    ...
    apl.Regular_Price,
    apl.Country_Code,
    apl.First_Date_of_Sale                               -- ✅ EDIT 4 (column)
  ...
  WHERE mc.report_date >= apl.First_Date_of_Sale         -- ✅ EDIT 4 (KEY FILTER)
),
...
aggregated_output AS (
  SELECT
    ...
    MAX(cd.First_Date_of_Sale) as First_Date_of_Sale,    -- ✅ EDIT 5
...
WHERE ao.report_date >= ao.First_Date_of_Sale            -- ✅ EDIT 6 (SAFETY NET)
