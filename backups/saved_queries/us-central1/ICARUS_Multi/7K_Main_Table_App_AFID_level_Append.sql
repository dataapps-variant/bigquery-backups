CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_7K_Main_Table_App_AFID_level_Append`()
BEGIN
-- =====================================================
...
-- =====================================================
DELETE FROM `variant-finance-data-project.ICARUS_Multi.7K_Main_Table_App_AFID_level`
WHERE Report_date >= DATE_SUB(
  (SELECT MAX(Report_date) FROM `variant-finance-data-project.ICARUS_Multi.7K_Main_Table_App_AFID_level`),  -- ▼ (2 of 4) ▼
...
IF days_to_process > 0 THEN
  ...
  -- =====================================================
  INSERT INTO `variant-finance-data-project.ICARUS_Multi.7K_Main_Table_App_AFID_level`
