-- job_id: scheduled_query_6a92c0b6-0000-2343-a295-24058876f4a8
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-08-01T08:00:03.478000+00:00
-- started: 2026-08-01T08:00:03.780000+00:00
-- ended: 2026-08-01T08:00:05.197000+00:00

CREATE OR REPLACE TABLE `variant-finance-data-project.R100.AT_Refunds` AS
WITH 
...
-- Find products from other apps that map to AT
...
base_refunds AS (
    ...
    -- Refunds from other apps that map to AT
    SELECT 
...
WHERE COALESCE(upd.Updated_App_Name, base.App_Name) = 'AT'
