-- job_id: scheduled_query_6a846b08-0000-2191-a113-fc4116926309
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-08-01T08:00:23.788000+00:00
-- started: 2026-08-01T08:00:24.054000+00:00
-- ended: 2026-08-01T08:00:25.245000+00:00

CREATE OR REPLACE TABLE `variant-finance-data-project.R100.IQ_Refunds` AS
WITH 
...
-- Find products from other apps that map to IQ
...
base_refunds AS (
    ...
    -- Refunds from other apps that map to IQ
    SELECT 
...
WHERE COALESCE(upd.Updated_App_Name, base.App_Name) = 'IQ'
