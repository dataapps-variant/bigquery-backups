-- job_id: scheduled_query_6a92c0be-0000-2343-a295-24058876f4a8
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-08-01T08:00:04.654000+00:00
-- started: 2026-08-01T08:00:05.244000+00:00
-- ended: 2026-08-01T08:00:06.668000+00:00

CREATE OR REPLACE TABLE `variant-finance-data-project.R100.CN_new_trailing100` AS
WITH 
...
-- Step 1B: Find products from other apps that map to CN
...
base_data AS (
    -- Step 1A: First data source - Direct CN data from Sticky table
    SELECT 
    ...
    -- Filter for last 100 days from current date and App_Name = "CN"
    ...
    -- Step 1B: Additional data from other apps that map to CN
    SELECT 
        -- Day Charged (past 100 days) - Date_of_Sale filtered for last 100 days
...
-- Filter to keep only records where APP_SHORT_NAME = "CN" after lookup
WHERE COALESCE(upd.Updated_App_Name, base.APP_SHORT_NAME) = 'CN'
