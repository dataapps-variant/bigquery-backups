-- job_id: scheduled_query_6a8d5a75-0000-2fd9-ad59-30fd3813e120
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-08-01T09:00:05.052000+00:00
-- started: 2026-08-01T09:00:05.363000+00:00
-- ended: 2026-08-01T09:01:09.092000+00:00

CREATE OR REPLACE TABLE `variant-finance-data-project.ICARUS_Multi.7k_SOT_Ratio_App_AFID` AS
...
-- =====================================================
-- APP × AFID LIST (from Plan_List)
-- Derive distinct App_Name × Country_Code × AFID combinations
...
-- Top 7,000 users per App_Name × Country_Code × AFID × BC
...
subscription_cohort AS (
  SELECT 
    ...
    base.Delay_days_SOT,
    ROW_NUMBER() OVER (
      PARTITION BY mc.report_date, mc.App_Name, mc.Country_Code, mc.AFID, mc.billing_cycle
...
ORDER BY mc.report_date DESC, mc.App_Name, mc.Country_Code, mc.AFID, mc.billing_cycle;

-- =====================================================
-- SCRIPT COMPLETE - 7K SOT RATIO APP × AFID LEVEL
-- Table: variant-finance-data-project.ICARUS_Multi.7k_SOT_Ratio_App_AFID
--
-- GRAIN: Report_date × App_Name × Country_Code × AFID × Billing_Cycle
--
-- METHODOLOGY:
-- Same as App-level SOT (7k cohort, count on-time vs total)
-- but at App_Name + Country_Code + AFID grain
--
