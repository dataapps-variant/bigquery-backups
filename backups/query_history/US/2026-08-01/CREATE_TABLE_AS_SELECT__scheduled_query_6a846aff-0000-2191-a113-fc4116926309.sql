-- job_id: scheduled_query_6a846aff-0000-2191-a113-fc4116926309
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-08-01T08:00:07.931000+00:00
-- started: 2026-08-01T08:00:08.245000+00:00
-- ended: 2026-08-01T08:00:11.312000+00:00

CREATE OR REPLACE TABLE `variant-finance-data-project.R100.CL_Refunds` AS
WITH 
...
-- Find products from other apps that map to CL
...
base_refunds AS (
    ...
    -- Refunds from other apps that map to CL
    SELECT 
...
WHERE COALESCE(upd.Updated_App_Name, base.App_Name) = 'CL'
