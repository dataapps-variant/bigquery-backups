-- job_id: 2a4618ea-9a0e-49bd-b0c3-747cf517582c
-- user: 1041741270489-compute@developer.gserviceaccount.com
-- statement_type: None
-- created: 2026-08-01T10:15:56.184000+00:00
-- started: 2026-08-01T10:15:56.196000+00:00
-- ended: 2026-08-01T10:15:56.196000+00:00
...
SELECT 'RT' AS app, repeat_failures.*, coalesce(app_ranks.alert_level, 0) AS app_priority, coalesce(app_ranks.subs_count_t30d, 0) AS subs_count_t30d FROM (SELECT max(c) AS total, array_agg(DISTINCT decline_reason) AS decline_reasons FROM (
