-- job_id: fa7701f2-26bd-4a7c-8bb2-f6db8f88bb03
-- user: 1041741270489-compute@developer.gserviceaccount.com
-- statement_type: SELECT
-- created: 2026-08-01T12:18:29.777000+00:00
-- started: 2026-08-01T12:18:29.980000+00:00
-- ended: 2026-08-01T12:18:33.179000+00:00


    WITH order_data AS (
    SELECT report_date, t_type, decline_reason, count(*) AS count FROM(
    SELECT * FROM (
    SELECT Order_Id AS order_id, Bill_Email AS email_address, Date_of_Sale AS report_date, CASE WHEN Billing_Cycle = '0' THEN 'CIT' ELSE 'MIT' END AS t_type, regexp_replace(Decline_Reason, r'(Unable to authorize payment for payment method ([0-9]*); Transaction Id: ([0-9]*)\.)|(Transaction ID = ([A-Z0-9]*))|(REFID:([0-9]*))', '') AS decline_reason FROM `variant-finance-data-project.Sticky_Data.Sticky_data_API_original_FS`
