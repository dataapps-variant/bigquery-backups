-- job_id: scheduled_query_6a7bbce7-0000-2343-a295-24058876f4a8
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-07-30T10:30:02.574000+00:00
-- started: 2026-07-30T10:30:03.145000+00:00
-- ended: 2026-07-30T10:31:01.465000+00:00

-- =====================================================
-- CWC MAIN TABLE CREATION SCRIPT - FINAL VERSION
...
-- Updated: AFID dimension added at Product × Country × AFID level
-- Updated: Cohort size changed to 35,000
-- Updated: Date range to Current Date to last 100 days
-- Updated: NULL AFID marked as 80 (INTEGER)
-- Updated: Plan_List JOIN includes AFID
-- Updated: Added T7D_Spend and T7D_Users columns
-- Updated: Added Net_BC4_ARPU column (optimized)
-- Updated: Added Entity Level (EL) columns for App-level aggregation
-- CHANGE 1: Added SS_Users and SS_Value columns
-- CHANGE 2: Net_ARPU_Discounted now includes SS_Value
-- CHANGE 3: Recent Spend/Users date window changed to report_date - 6 days to report_date
-- CHANGE 4: Product_Name_Final → Product_Name_Final_Merged for transaction/spend tables
-- CHANGE 5: Added Plan_List aggregation logic to handle duplicate trial types
-- CHANGE 6: Removed Entity Level (EL) columns
-- CHANGE 7: Added Net_LTV_Discounted column (Net_ARPU_Discounted - Recent_CAC)
-- =====================================================

CREATE OR REPLACE TABLE `variant-finance-data-project.CWC.CWC_Main_Table` AS
  ...
  SELECT 
   ...
   rs4.base_refund_ratio as final_refund_ratio,
    ...
    CASE 
      ...
      ELSE COALESCE(
        SAFE_DIVIDE(rs4.clean_rebill_value + COALESCE(rs4.clean_ss_value, 0), NULLIF(rs4.clean_rebill_users, 0)) * (rs4.final_retention_rate - rs4.base_refund_ratio),
        0.0
      )
