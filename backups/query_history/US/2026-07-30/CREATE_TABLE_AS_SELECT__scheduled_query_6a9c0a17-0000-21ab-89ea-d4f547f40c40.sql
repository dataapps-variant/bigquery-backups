-- job_id: scheduled_query_6a9c0a17-0000-21ab-89ea-d4f547f40c40
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-07-30T08:00:07.113000+00:00
-- started: 2026-07-30T08:00:07.376000+00:00
-- ended: 2026-07-30T08:00:08.683000+00:00

CREATE OR REPLACE TABLE `variant-finance-data-project.R100.RT_Refunds` AS
WITH 
...
-- Find products from other apps that map to RT
...
base_refunds AS (
    ...
    -- Refunds from other apps that map to RT
    SELECT 
...
WHERE COALESCE(upd.Updated_App_Name, base.App_Name) = 'RT'
