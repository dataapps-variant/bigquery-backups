-- job_id: scheduled_query_6a9c0a1f-0000-21ab-89ea-d4f547f40c40
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-07-30T08:00:05.941000+00:00
-- started: 2026-07-30T08:00:06.269000+00:00
-- ended: 2026-07-30T08:00:07.529000+00:00

CREATE OR REPLACE TABLE `variant-finance-data-project.R100.PD_Refunds` AS
WITH 
...
-- Find products from other apps that map to PD
...
base_refunds AS (
    ...
    -- Refunds from other apps that map to PD
    SELECT 
...
WHERE COALESCE(upd.Updated_App_Name, base.App_Name) = 'PD'
