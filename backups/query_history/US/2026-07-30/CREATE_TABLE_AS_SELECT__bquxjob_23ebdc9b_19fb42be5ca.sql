-- job_id: bquxjob_23ebdc9b_19fb42be5ca
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-07-30T17:56:48.409000+00:00
-- started: 2026-07-30T17:56:48.902000+00:00
-- ended: 2026-07-30T17:56:51.409000+00:00
...
-- Base data with decline reason breakdown per order
base_data AS (
  SELECT
    order_date,
    CASE
...
-- Reason level aggregation per day
reason_level AS (
  SELECT
    order_date,
    order_outcome,
