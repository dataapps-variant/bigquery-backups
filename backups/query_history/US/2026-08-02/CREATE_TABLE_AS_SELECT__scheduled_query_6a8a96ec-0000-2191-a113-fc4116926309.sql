-- job_id: scheduled_query_6a8a96ec-0000-2191-a113-fc4116926309
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-08-02T08:00:10.930000+00:00
-- started: 2026-08-02T08:00:11.164000+00:00
-- ended: 2026-08-02T08:00:14.512000+00:00

CREATE OR REPLACE TABLE `variant-finance-data-project.R100.RL_Refunds` AS
WITH 
...
-- Find products from other apps that map to RL
...
base_refunds AS (
    ...
    -- Refunds from other apps that map to RL
    SELECT 
...
WHERE COALESCE(upd.Updated_App_Name, base.App_Name) = 'RL'
