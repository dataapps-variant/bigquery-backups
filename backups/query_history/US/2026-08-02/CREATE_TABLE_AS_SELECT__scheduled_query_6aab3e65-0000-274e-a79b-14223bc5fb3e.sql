-- job_id: scheduled_query_6aab3e65-0000-274e-a79b-14223bc5fb3e
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-08-02T08:15:03.226000+00:00
-- started: 2026-08-02T08:15:03.536000+00:00
-- ended: 2026-08-02T08:16:30.134000+00:00
...
SELECT 
  ...
  b.App_Name,
  b.Entity,
  CAST(COALESCE(a.Actual_Spend_MTD, 0) AS INT64) AS Actual_Spend_MTD,
  CAST(COALESCE(t.Target_Spend_MTD, 0) AS INT64) AS Target_Spend_MTD,
  CAST(COALESCE(t.Target_Spend_MTD, 0) - COALESCE(a.Actual_Spend_MTD, 0) AS INT64) AS Delta_Spend,
  ...
  CASE 
    ...
    ELSE ROUND((COALESCE(t.Target_Spend_MTD, 0) - COALESCE(a.Actual_Spend_MTD, 0)) / COALESCE(t.Target_Spend_MTD, 0), 4)
  END AS Delta_Spend_Percent,
  -- Delta Users % = Delta Users / Target New Users (MTD)
  CASE 
    WHEN COALESCE(t.Target_New_Users_MTD, 0) = 0 THEN NULL
    ELSE ROUND((COALESCE(t.Target_New_Users_MTD, 0) - (COALESCE(s.Sticky_User_Count_MTD, 0) - COALESCE(ss.SS_User_Count_MTD, 0))) / COALESCE(t.Target_New_Users_MTD, 0), 4)
  ...
  CASE 
    ...
    ELSE ROUND(COALESCE(a.Actual_Spend_MTD, 0) / (COALESCE(s.Sticky_User_Count_MTD, 0) - COALESCE(ss.SS_User_Count_MTD, 0)), 2)
  END AS Actual_CAC,
  -- Target CAC = Target Spend / Target New Users
  CASE 
    WHEN COALESCE(t.Target_New_Users_MTD, 0) = 0 THEN NULL
    ELSE ROUND(COALESCE(t.Target_Spend_MTD, 0) / COALESCE(t.Target_New_Users_MTD, 0), 2)
  END AS Target_CAC,
  ...
  CASE 
    ...
    ELSE ROUND((COALESCE(t.Target_Spend_MTD, 0) / COALESCE(t.Target_New_Users_MTD, 0)) - (COALESCE(a.Actual_Spend_MTD, 0) / (COALESCE(s.Sticky_User_Count_MTD, 0) - COALESCE(ss.SS_User_Count_MTD, 0))), 2)
  END AS Delta_CAC,
  -- Delta CAC % = Delta CAC / Target CAC
  CASE 
    WHEN COALESCE(t.Target_New_Users_MTD, 0) = 0 OR (COALESCE(s.Sticky_User_Count_MTD, 0) - COALESCE(ss.SS_User_Count_MTD, 0)) = 0 THEN NULL
    WHEN (COALESCE(t.Target_Spend_MTD, 0) / COALESCE(t.Target_New_Users_MTD, 0)) = 0 THEN NULL
    ELSE ROUND(((COALESCE(t.Target_Spend_MTD, 0) / COALESCE(t.Target_New_Users_MTD, 0)) - (COALESCE(a.Actual_Spend_MTD, 0) / (COALESCE(s.Sticky_User_Count_MTD, 0) - COALESCE(ss.SS_User_Count_MTD, 0)))) / (COALESCE(t.Target_Spend_MTD, 0) / COALESCE(t.Target_New_Users_MTD, 0)), 4)
