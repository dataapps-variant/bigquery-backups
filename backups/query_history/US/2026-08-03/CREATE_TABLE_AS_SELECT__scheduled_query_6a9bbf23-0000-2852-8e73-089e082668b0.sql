-- job_id: scheduled_query_6a9bbf23-0000-2852-8e73-089e082668b0
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-08-03T08:00:08.283000+00:00
-- started: 2026-08-03T08:00:09.291000+00:00
-- ended: 2026-08-03T08:00:10.766000+00:00

CREATE OR REPLACE TABLE `variant-finance-data-project.R100.MB_Refunds` AS
WITH 
...
-- Find products from other apps that map to MB
...
base_refunds AS (
    ...
    -- Refunds from other apps that map to MB
    SELECT 
...
WHERE COALESCE(upd.Updated_App_Name, base.App_Name) = 'MB'
AND base.Day_Refunded < CURRENT_DATE()
