-- job_id: 1e0cc6ac-3909-4929-b50f-0f4bf4684597
-- user: 1041741270489-compute@developer.gserviceaccount.com
-- statement_type: None
-- created: 2026-08-03T07:15:39.711000+00:00
-- started: 2026-08-03T07:15:39.725000+00:00
-- ended: 2026-08-03T07:15:39.725000+00:00
...
SELECT 'RL' AS app, repeat_failures.*, coalesce(app_ranks.alert_level, 0) AS app_priority, coalesce(app_ranks.subs_count_t30d, 0) AS subs_count_t30d FROM (SELECT max(c) AS total, array_agg(DISTINCT decline_reason) AS decline_reasons FROM (
