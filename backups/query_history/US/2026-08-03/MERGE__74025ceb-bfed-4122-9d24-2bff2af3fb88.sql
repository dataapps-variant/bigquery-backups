-- job_id: 74025ceb-bfed-4122-9d24-2bff2af3fb88
-- user: sticky-maintainer@variant-finance-data-project.iam.gserviceaccount.com
-- statement_type: MERGE
-- created: 2026-08-03T11:03:07.481000+00:00
-- started: 2026-08-03T11:03:07.929000+00:00
-- ended: 2026-08-03T11:03:09.560000+00:00
...
USING (
  ...
  updates_orders AS (
    SELECT order_id, last_modified
    FROM `variant-finance-data-project.Sticky_Data.Updates_orders_CN`
  ),
  case_a_missing AS (
    SELECT
      u.order_id,
  ...
  SELECT order_id, remark, 'contractsdotnetllc' AS company, last_modified
  FROM case_a_missing
  UNION ALL
  SELECT order_id, remark, 'contractsdotnetllc' AS company, last_modified
