-- job_id: scheduled_query_6a6ed971-0000-2343-a295-24058876f4a8
-- user: dataapps@variant.net
-- statement_type: SCRIPT
-- created: 2026-07-29T08:45:02.810000+00:00
-- started: 2026-07-29T08:45:02.849000+00:00
-- ended: 2026-07-29T08:45:56.661000+00:00
...
final_calculations AS (
  SELECT 
    ...
    CASE 
      ...
      WHEN rs12.final_retention_rate = 0 THEN 0.0
      ELSE COALESCE(
        SAFE_DIVIDE(rs12.clean_rebill_value + COALESCE(rs12.clean_ss_value, 0), NULLIF(rs12.clean_rebill_users, 0)) * (rs12.final_retention_rate - rs12.base_refund_ratio),
        0.0
      )
