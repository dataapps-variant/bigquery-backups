-- job_id: job_EK7wyDucZ_ZuAh4ClGD0XbuNqW3D
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-07-29T13:56:19.393000+00:00
-- started: 2026-07-29T13:56:19.783000+00:00
-- ended: 2026-07-29T13:56:22.865000+00:00
...
cohort_priority AS (
  SELECT Plan_Name, Cohort, Active_Inactive, bc_level, retention_rate,
    ROW_NUMBER() OVER (
...
combined AS (
  SELECT
    i.Input_ID,
    i.Entity,
    i.Retention_Curve AS Curve_Name,
    b.bc AS bc_level,
  ...
  LEFT JOIN best_icarus ic
    ON ic.Plan_Name = i.Retention_Curve AND ic.bc_level = b.bc
