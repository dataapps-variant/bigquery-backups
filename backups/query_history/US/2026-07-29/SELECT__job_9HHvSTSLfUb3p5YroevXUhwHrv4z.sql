-- job_id: job_9HHvSTSLfUb3p5YroevXUhwHrv4z
-- user: dataapps@variant.net
-- statement_type: SELECT
-- created: 2026-07-29T14:44:03.952000+00:00
-- started: 2026-07-29T14:44:04.098000+00:00
-- ended: 2026-07-29T14:44:05.607000+00:00
...
SELECT
  ROW_NUMBER() OVER (ORDER BY Input_ID, Billing_Cycle) AS Row,
  Entity,
  Retention_Curve AS Curve_Name,
  Billing_Cycle AS bc_level,
  CONCAT(FORMAT('%.2f', final_retention * 100), '%') AS retention_pct,
  Source,
