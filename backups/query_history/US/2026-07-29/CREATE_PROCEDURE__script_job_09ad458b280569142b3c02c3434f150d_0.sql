-- job_id: script_job_09ad458b280569142b3c02c3434f150d_0
-- user: dataapps@variant.net
-- statement_type: CREATE_PROCEDURE
-- created: 2026-07-29T09:57:16.454000+00:00
-- started: 2026-07-29T09:57:16.632000+00:00
-- ended: 2026-07-29T09:57:16.774000+00:00

CREATE OR REPLACE PROCEDURE `Icarus_Spend_Country_AFID.proc_SCA_7K_Main_Table_App_level_Append`()
BEGIN
-- =====================================================
...
IF days_to_process > 0 THEN
  ...
  -- =====================================================
  INSERT INTO `variant-finance-data-project.Icarus_Spend_Country_AFID.SCA_7K_Main_Table_App_level`
...
-- =====================================================
-- CTE 2: LAST SPEND DATE PER APP + SCA
-- =====================================================
last_spend_dates AS (
  SELECT 
    aba.Report_date,
...
-- =====================================================
-- CTE 4: RECENT USERS
-- Match on Spend_Country_Code_AFID directly
-- =====================================================
...
-- =====================================================
-- CTE 6: ASSEMBLE BASE DATA + CHURN RATE + REFUND LOOKUP
-- =====================================================
with_churn AS (
  SELECT 
    aba.Report_date,
  ...
  LEFT JOIN recent_spend_calc rsc
    ...
    AND aba.Spend_Country_Code_AFID = rsc.Spend_Country_Code_AFID
  ...
  LEFT JOIN recent_users_calc ruc
    ...
    AND aba.Spend_Country_Code_AFID = ruc.Spend_Country_Code_AFID
    AND aba.Billing_Cycle = 0
  LEFT JOIN t30d_new_users_calc t30d
    ...
    AND aba.Spend_Country_Code_AFID = t30d.Spend_Country_Code_AFID
...
-- =====================================================
-- RETENTION CASCADE (12 BCs, partitioned by SCA grain)
-- =====================================================
retention_step_0 AS (
  SELECT wc.*,
