-- job_id: scheduled_query_6a87df1f-0000-2548-9a5c-30fd380f88f8
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-07-29T08:00:14.795000+00:00
-- started: 2026-07-29T08:00:15.097000+00:00
-- ended: 2026-07-29T08:00:16.242000+00:00

CREATE OR REPLACE TABLE `variant-finance-data-project.R100.JF_Refunds` AS
WITH 
...
-- Find products from other apps that map to JF
...
base_refunds AS (
    ...
    -- Refunds from other apps that map to JF
    SELECT 
...
WHERE COALESCE(upd.Updated_App_Name, base.App_Name) = 'JF'
