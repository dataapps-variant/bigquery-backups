-- job_id: scheduled_query_6a749d47-0000-2535-a1a3-089e0831bf14
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-07-29T08:00:07.795000+00:00
-- started: 2026-07-29T08:00:08.158000+00:00
-- ended: 2026-07-29T08:00:09.424000+00:00

CREATE OR REPLACE TABLE `variant-finance-data-project.R100.FS_Refunds` AS
WITH 
...
-- Find products from other apps that map to FS
...
base_refunds AS (
    ...
    -- Refunds from other apps that map to FS
    SELECT 
...
WHERE COALESCE(upd.Updated_App_Name, base.App_Name) = 'FS'
