-- job_id: d4ec875a-37b0-4b0a-910b-6dab5f652cf6
-- user: sticky-maintainer@variant-finance-data-project.iam.gserviceaccount.com
-- statement_type: MERGE
-- created: 2026-07-31T11:02:53.059000+00:00
-- started: 2026-07-31T11:02:53.475000+00:00
-- ended: 2026-07-31T11:02:54.895000+00:00
...
USING (
  ...
  updates_orders AS (
    SELECT order_id, last_modified
    FROM `variant-finance-data-project.Sticky_Data.Updates_orders_AT`
  ),
  case_a_missing AS (
    SELECT
      u.order_id,
  ...
  SELECT order_id, remark, 'brainable' AS company, last_modified
  FROM case_a_missing
  UNION ALL
  SELECT order_id, remark, 'brainable' AS company, last_modified
