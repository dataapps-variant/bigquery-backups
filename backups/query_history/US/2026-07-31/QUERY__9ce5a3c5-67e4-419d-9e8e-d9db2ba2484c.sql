-- job_id: 9ce5a3c5-67e4-419d-9e8e-d9db2ba2484c
-- user: 1041741270489-compute@developer.gserviceaccount.com
-- statement_type: None
-- created: 2026-07-31T15:17:00.872000+00:00
-- started: 2026-07-31T15:17:00.883000+00:00
-- ended: 2026-07-31T15:17:00.883000+00:00
...
SELECT 'CV' AS app, repeat_failures.*, coalesce(app_ranks.alert_level, 0) AS app_priority, coalesce(app_ranks.subs_count_t30d, 0) AS subs_count_t30d FROM (SELECT max(c) AS total, array_agg(DISTINCT decline_reason) AS decline_reasons FROM (
