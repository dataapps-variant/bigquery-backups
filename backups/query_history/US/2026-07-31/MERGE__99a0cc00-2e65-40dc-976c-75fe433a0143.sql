-- job_id: 99a0cc00-2e65-40dc-976c-75fe433a0143
-- user: sticky-maintainer@variant-finance-data-project.iam.gserviceaccount.com
-- statement_type: MERGE
-- created: 2026-07-31T11:10:02.509000+00:00
-- started: 2026-07-31T11:10:02.920000+00:00
-- ended: 2026-07-31T11:10:04.341000+00:00
...
USING (
  ...
  sticky_data AS (
    ...
    FROM (
      ...
      FROM `variant-finance-data-project.Sticky_Data.Sticky_data_API_updated_CT`
    )
    WHERE rn = 1
  ),
  updates_orders AS (
    SELECT order_id, last_modified
    FROM `variant-finance-data-project.Sticky_Data.Updates_orders_CT`
  ),
  case_a_missing AS (
    SELECT
      u.order_id,
  ...
  SELECT order_id, remark, 'mindworksllc' AS company, last_modified
  FROM case_a_missing
  UNION ALL
  SELECT order_id, remark, 'mindworksllc' AS company, last_modified
