...
WHERE Final_Order_Status <> 7 AND Billing_Cycle = '0' AND App_Name IN ('CT') AND Trial_Type <> 'SS' AND AFID <> '' AND Date_of_Sale >= current_date - 30 GROUP BY AFID) AS d) AS z ON d.afid = z.afid
