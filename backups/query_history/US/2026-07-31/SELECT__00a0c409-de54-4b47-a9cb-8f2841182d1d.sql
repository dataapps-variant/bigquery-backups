-- job_id: 00a0c409-de54-4b47-a9cb-8f2841182d1d
-- user: 1041741270489-compute@developer.gserviceaccount.com
-- statement_type: SELECT
-- created: 2026-07-31T12:17:38.202000+00:00
-- started: 2026-07-31T12:17:38.363000+00:00
-- ended: 2026-07-31T12:17:41.783000+00:00
...
ORDER BY subs_count_t30d DESC) AS app_ranks ON app_ranks.app = 'CV'
...
WHERE Final_Order_Status <> 7 AND Billing_Cycle = '0' AND App_Name IN ('CV') AND Trial_Type <> 'SS' AND AFID <> '' AND Date_of_Sale >= current_date - 30 GROUP BY AFID) AS d) AS z ON d.afid = z.afid
