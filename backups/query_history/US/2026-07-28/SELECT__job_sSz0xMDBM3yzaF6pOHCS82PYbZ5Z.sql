-- job_id: job_sSz0xMDBM3yzaF6pOHCS82PYbZ5Z
-- user: apache-superset-admin@variant-finance-data-project.iam.gserviceaccount.com
-- statement_type: SELECT
-- created: 2026-07-28T12:56:57.649000+00:00
-- started: 2026-07-28T12:56:57.739000+00:00
-- ended: 2026-07-28T12:56:57.950000+00:00

SELECT `Product_Name_Final` AS `Product_Name_Final`, sum(`CB_Profit`) AS `Profit` 
FROM (SELECT 
  a.*,
  CASE 
