-- job_id: scheduled_query_6a6b33e9-0000-2bae-a049-7474463f9b85
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-07-28T08:00:18.345000+00:00
-- started: 2026-07-28T08:00:18.610000+00:00
-- ended: 2026-07-28T08:00:20.028000+00:00

CREATE OR REPLACE TABLE `variant-finance-data-project.R100.CV_Refunds` AS
WITH 
...
-- Find products from other apps that map to CV
...
base_refunds AS (
    ...
    -- Refunds from other apps that map to CV
    SELECT 
...
WHERE COALESCE(upd.Updated_App_Name, base.App_Name) = 'CV'
