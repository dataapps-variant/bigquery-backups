-- job_id: scheduled_query_6a71dcf3-0000-21ab-89ea-d4f547f40c40
-- user: dataapps@variant.net
-- statement_type: SCRIPT
-- created: 2026-07-28T08:15:02.267000+00:00
-- started: 2026-07-28T08:15:02.336000+00:00
-- ended: 2026-07-28T08:15:05.432000+00:00

DECLARE month_start DATE DEFAULT DATE '2025-04-01';
DECLARE month_end DATE DEFAULT DATE_TRUNC(CURRENT_DATE(), MONTH);
DECLARE months_array ARRAY<DATE>;
DECLARE pivot_columns STRING;
DECLARE last_3_months_expr STRING;
DECLARE query STRING;

SET months_array = GENERATE_DATE_ARRAY(month_start, DATE_SUB(month_end, INTERVAL 1 DAY), INTERVAL 1 MONTH);
