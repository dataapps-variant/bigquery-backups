-- job_id: 9b42ce20-63c6-4e17-8d35-84c781e6cabf
-- user: 1041741270489-compute@developer.gserviceaccount.com
-- statement_type: SELECT
-- created: 2026-07-28T02:20:47.148000+00:00
-- started: 2026-07-28T02:20:47.235000+00:00
-- ended: 2026-07-28T02:20:48.635000+00:00
...
SELECT 'CT - US' AS app, repeat_failures.*, coalesce(app_ranks.alert_level, 0) AS app_priority, coalesce(app_ranks.subs_count_t30d, 0) AS subs_count_t30d FROM (SELECT max(c) AS total, array_agg(DISTINCT decline_reason) AS decline_reasons FROM (
