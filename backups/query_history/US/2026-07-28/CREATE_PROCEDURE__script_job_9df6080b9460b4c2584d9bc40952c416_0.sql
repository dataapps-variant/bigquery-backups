-- job_id: script_job_9df6080b9460b4c2584d9bc40952c416_0
-- user: dataapps@variant.net
-- statement_type: CREATE_PROCEDURE
-- created: 2026-07-28T18:06:42.075000+00:00
-- started: 2026-07-28T18:06:42.268000+00:00
-- ended: 2026-07-28T18:06:42.419000+00:00

CREATE OR REPLACE PROCEDURE `Icarus_Spend_Country_AFID.proc_SCA_7K_Main_Table_Append`()
BEGIN
-- =====================================================
...
IF days_to_process > 0 THEN
  ...
  -- =====================================================
  INSERT INTO `variant-finance-data-project.Icarus_Spend_Country_AFID.SCA_7K_Main_Table`
