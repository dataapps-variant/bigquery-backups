-- job_id: script_job_c7c23571172d691a50b2addbc97ce6b1_3
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-07-28T08:15:03.610000+00:00
-- started: 2026-07-28T08:15:03.899000+00:00
-- ended: 2026-07-28T08:15:05.194000+00:00
...
CREATE OR REPLACE TABLE `variant-finance-data-project.Icarus_Cohort.IC_AFID_List` AS
  ...
  SELECT
    *,
    CASE WHEN (`Apr_2026` + `May_2026` + `Jun_2026`) > 50 THEN 'Yes' ELSE 'No' END AS Last_3_Months_Over_50
  FROM base
