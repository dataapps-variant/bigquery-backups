-- job_id: 515dd057-c9ee-4161-a16f-e7705270294a
-- user: 1041741270489-compute@developer.gserviceaccount.com
-- statement_type: SELECT
-- created: 2026-07-28T12:16:48.927000+00:00
-- started: 2026-07-28T12:16:49.162000+00:00
-- ended: 2026-07-28T12:16:51.909000+00:00
...
WHERE Final_Order_Status <> 7 AND Billing_Cycle = '0' AND App_Name IN ('JF') AND Trial_Type <> 'SS' AND AFID <> '' AND Date_of_Sale >= current_date - 30 GROUP BY AFID) AS d) AS z ON d.afid = z.afid
