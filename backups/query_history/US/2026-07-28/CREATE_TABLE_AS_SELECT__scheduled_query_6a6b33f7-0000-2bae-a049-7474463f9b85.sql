-- job_id: scheduled_query_6a6b33f7-0000-2bae-a049-7474463f9b85
-- user: dataapps@variant.net
-- statement_type: CREATE_TABLE_AS_SELECT
-- created: 2026-07-28T08:00:18.986000+00:00
-- started: 2026-07-28T08:00:19.855000+00:00
-- ended: 2026-07-28T08:00:23.351000+00:00

CREATE OR REPLACE TABLE `variant-finance-data-project.R100.EN_new_trailing100` AS
WITH 
...
-- Step 1B: Find products from other apps that map to EN
...
base_data AS (
    -- Step 1A: First data source - Direct EN data from Sticky table
    SELECT 
    ...
    -- Filter for last 100 days from current date and App_Name = "EN"
    ...
    -- Step 1B: Additional data from other apps that map to EN
    SELECT 
        -- Day Charged (past 100 days) - Date_of_Sale filtered for last 100 days
...
-- Filter to keep only records where APP_SHORT_NAME = "EN" after lookup
WHERE COALESCE(upd.Updated_App_Name, base.APP_SHORT_NAME) = 'EN'
