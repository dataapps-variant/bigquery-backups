CREATE VIEW `variant-finance-data-project.Sticky_Data.Sticky_data_API_original_JF`
AS WITH combined_data AS (
  -- Union all the JF tables first
  SELECT
...
UNION ALL
  ...
  SELECT
    ...
    custom_fields AS custom_fields,
    cc_first_6 AS BIN
  FROM `variant-finance-data-project.Sticky_Data.test_Sticky_data_API_original_JF_Incremental`
