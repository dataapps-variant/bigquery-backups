CREATE VIEW `variant-finance-data-project.Sticky_Data.Sticky_data_API_original_AT`
AS WITH combined_data AS (
  -- Union all the tables first
  SELECT
  ...
  SELECT
    ...
    prd_offer_id AS Offer_Id,
    cc_first_6 AS BIN
  FROM `variant-finance-data-project.Sticky_Data.Sticky_data_API_updated_AT`
...
UNION ALL
  ...
  SELECT
    ...
    prd_offer_id AS Offer_Id,
    cc_first_6 AS BIN
  FROM `variant-finance-data-project.Sticky_Data.Sticky_data_API_original_AT_Incremental`
