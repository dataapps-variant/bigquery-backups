...
extension_parsed AS (
  ...
  UNPIVOT (
    churn_rate FOR bc_col IN (
      ...
      BC36 AS 'BC36', BC37 AS 'BC37', BC38 AS 'BC38', BC39 AS 'BC39',
      BC40 AS 'BC40', BC41 AS 'BC41', BC42 AS 'BC42', BC43 AS 'BC43',
      BC44 AS 'BC44', BC45 AS 'BC45', BC46 AS 'BC46', BC47 AS 'BC47',
      BC48 AS 'BC48', BC49 AS 'BC49', BC50 AS 'BC50', BC51 AS 'BC51',
      BC52 AS 'BC52', BC53 AS 'BC53', BC54 AS 'BC54', BC55 AS 'BC55',
      BC56 AS 'BC56', BC57 AS 'BC57', BC58 AS 'BC58', BC59 AS 'BC59',
      BC60 AS 'BC60'
    )
  )
),
...
bc_range AS (
  SELECT bc FROM UNNEST(GENERATE_ARRAY(0, 60)) AS bc
),
