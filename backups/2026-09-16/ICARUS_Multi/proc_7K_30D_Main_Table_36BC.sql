CREATE PROCEDURE `variant-finance-data-project`.ICARUS_Multi.proc_7K_30D_Main_Table_36BC()
BEGIN
...
CREATE OR REPLACE TABLE `variant-finance-data-project.ICARUS_Multi.7K_30D_Main_Table_36BC` AS
