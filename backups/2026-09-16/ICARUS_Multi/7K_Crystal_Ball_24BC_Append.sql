CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_7K_Crystal_Ball_24BC_Append`()
BEGIN
-- =====================================================
...
DECLARE fallback_date DATE DEFAULT DATE('2024-12-31');   -- 24BC: day BEFORE first date wanted
...
-- =====================================================
DELETE FROM `variant-finance-data-project.ICARUS_Multi.7K_Crystal_Ball_24BC`
WHERE Report_date >= DATE_SUB(
  (SELECT MAX(Report_date) FROM `variant-finance-data-project.ICARUS_Multi.7K_Crystal_Ball_24BC`),  -- ▼ (2 of 4) ▼
...
SET last_processed_date = (
  ...
  FROM `variant-finance-data-project.ICARUS_Multi.7K_Crystal_Ball_24BC`
);
...
IF days_to_process > 0 THEN
  ...
  -- =====================================================
  INSERT INTO `variant-finance-data-project.ICARUS_Multi.7K_Crystal_Ball_24BC`
...
config AS (
  SELECT 
    new_end_date   AS report_start_date,   -- APPEND: was DATE_SUB(CURRENT_DATE(), INTERVAL 1 DAY)
    new_start_date AS report_end_date,     -- APPEND: was DATE('2025-01-01')
    7000 AS cohort_size,
