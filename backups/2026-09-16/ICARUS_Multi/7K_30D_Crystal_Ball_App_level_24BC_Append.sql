CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_7K_30D_Crystal_Ball_App_level_24BC_Append`()
BEGIN
-- =====================================================
...
-- =====================================================
DELETE FROM `variant-finance-data-project.ICARUS_Multi.7K_30D_Crystal_Ball_App_level_24BC`
WHERE Report_date >= DATE_SUB(
  (SELECT MAX(Report_date) FROM `variant-finance-data-project.ICARUS_Multi.7K_30D_Crystal_Ball_App_level_24BC`),  -- ▼ (2 of 4) ▼
...
SET last_processed_date = (
  ...
  FROM `variant-finance-data-project.ICARUS_Multi.7K_30D_Crystal_Ball_App_level_24BC`
);
...
IF days_to_process > 0 THEN
  ...
  -- =====================================================
  INSERT INTO `variant-finance-data-project.ICARUS_Multi.7K_30D_Crystal_Ball_App_level_24BC`
...
WHERE App_Name IN (SELECT App_Name FROM active_vg_apps)
  AND Report_date BETWEEN new_start_date AND new_end_date
    ...
    CASE 
      ...
      WHEN rs12.Billing_Cycle = 13 THEN 
        CASE
          ...
          WHEN rs12.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs13.Billing_Cycle = 14 THEN 
        CASE
          ...
          WHEN rs13.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs14.Billing_Cycle = 15 THEN 
        CASE
          ...
          WHEN rs14.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs15.Billing_Cycle = 16 THEN 
        CASE
          ...
          WHEN rs15.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs16.Billing_Cycle = 17 THEN 
        CASE
          ...
          WHEN rs16.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs17.Billing_Cycle = 18 THEN 
        CASE
          ...
          WHEN rs17.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs18.Billing_Cycle = 19 THEN 
        CASE
          ...
          WHEN rs18.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs19.Billing_Cycle = 20 THEN 
        CASE
          ...
          WHEN rs19.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs20.Billing_Cycle = 21 THEN 
        CASE
          ...
          WHEN rs20.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs21.Billing_Cycle = 22 THEN 
        CASE
          ...
          WHEN rs21.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs22.Billing_Cycle = 23 THEN 
        CASE
          ...
          WHEN rs22.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
    ...
    CASE 
      ...
      WHEN rs23.Billing_Cycle = 24 THEN 
        CASE
          ...
          WHEN rs23.CB_User < (SELECT minimum_cb_users FROM config) THEN NULL
...
active_apps AS (
  ...
  FROM `variant-finance-data-project.ICARUS_Multi.Active_Plans_6M_24BC`
),
...
final_calculations AS (
  SELECT 
    ...
    CASE 
      WHEN rs24.App_Name = 'VG' THEN 'Active'
    ...
    CASE 
      ...
      ELSE COALESCE(
        ...
        SAFE_DIVIDE(rs24.Single_Sale_Value, NULLIF(rs24.Subscription_users, 0)),
        0.0
      )
