CREATE PROCEDURE `variant-finance-data-project`.ICARUS_Multi.proc_7k_SOT_Ratio_36BC()
BEGIN
...
-- 3. max_billing_cycles: 12 -> 36 (to match 7K_30D_Crystal_Ball_36BC)
-- 
-- PURPOSE:
...
CREATE OR REPLACE TABLE `variant-finance-data-project.ICARUS_Multi.7k_SOT_Ratio_36BC` AS
...
-- 6. max_billing_cycles changed from 12 to 36 (matches 7K_30D_Crystal_Ball_36BC)
-- 
