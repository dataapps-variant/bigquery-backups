CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_7K_Main_Table_24BC_Append`()
BEGIN
...
-- =====================================================
DELETE FROM `variant-finance-data-project.ICARUS_Multi.7K_Main_Table_24BC`
WHERE Report_date >= DATE_SUB(
  (SELECT MAX(Report_date) FROM `variant-finance-data-project.ICARUS_Multi.7K_Main_Table_24BC`),  -- ▼ (2 of 4) ▼
...
SET last_processed_date = (
  ...
  FROM `variant-finance-data-project.ICARUS_Multi.7K_Main_Table_24BC`
);
...
IF days_to_process > 0 THEN
  ...
  -- =====================================================
  INSERT INTO `variant-finance-data-project.ICARUS_Multi.7K_Main_Table_24BC`
...
plan_first_sale AS (
  ...
  WHERE Product_Name_Final_Merged IS NOT NULL
    ...
    AND Billing_Cycle_Updated BETWEEN 0 AND 24
    ...
    CASE 
      ...
      WHEN rs11.billing_cycle = 12 THEN 
        CASE
          ...
          -- Check if clean_rebill_users < minimum_rebill_users → set to NULL
