CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_7K_30D_Main_Table_App_level_36BC` ()
BEGIN
...
app_base_aggregated AS (
  ...
  FROM `variant-finance-data-project.ICARUS_Multi.7K_30D_Main_Table_36BC`
