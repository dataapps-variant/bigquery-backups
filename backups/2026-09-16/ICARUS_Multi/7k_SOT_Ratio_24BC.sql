...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_7k_SOT_Ratio_24BC`()
BEGIN
...
CREATE OR REPLACE TABLE `variant-finance-data-project.ICARUS_Multi.7k_SOT_Ratio_24BC` AS
