CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_7K_Main_Table_App_AFID_level`()
BEGIN

CREATE OR REPLACE TABLE `variant-finance-data-project.ICARUS_Multi.7K_Main_Table_App_AFID_level` AS
