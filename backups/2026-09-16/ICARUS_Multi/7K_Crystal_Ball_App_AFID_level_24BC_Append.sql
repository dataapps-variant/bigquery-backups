-- =====================================================
-- 7K_Crystal_Ball_App_AFID_level_24BC — INCREMENTAL APPEND
-- Converted from proc_7K_Crystal_Ball_App_AFID_level_24BC (full rebuild).
--
...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.ICARUS_Multi.proc_7K_Crystal_Ball_App_AFID_level_24BC_Append`()
BEGIN
  ...
  -- =====================================================
  DELETE FROM `variant-finance-data-project.ICARUS_Multi.7K_Crystal_Ball_App_AFID_level_24BC`
  WHERE Report_date >= DATE_SUB(
    (SELECT MAX(Report_date) FROM `variant-finance-data-project.ICARUS_Multi.7K_Crystal_Ball_App_AFID_level_24BC`),
  ...
  SET last_processed_date = (
    ...
    FROM `variant-finance-data-project.ICARUS_Multi.7K_Crystal_Ball_App_AFID_level_24BC`
  );
  ...
  IF days_to_process > 0 THEN
    ...
    -- =====================================================
    INSERT INTO `variant-finance-data-project.ICARUS_Multi.7K_Crystal_Ball_App_AFID_level_24BC` (
...
app_afid_base_aggregated AS (
  ...
  FROM `variant-finance-data-project.Icarus_Cohort.IC_7K_Crystal_Ball_24BC`
...
-- =====================================================
-- DIFFERENCES FROM THE MAIN TABLE AFID SIBLING
-- =====================================================
-- These two procedures look nearly identical. They are not interchangeable:
--
--   source   : IC_7K_Crystal_Ball_24BC   (not IC_7K_Main_Table_24BC)
...
-- 2. The gate resolves to NULL, not 0.0. IC_7K_Crystal_Ball_24BC uses 0.0
...
-- =====================================================
--   target : ICARUS_Multi.7K_Crystal_Ball_App_AFID_level_24BC
--   source : Icarus_Cohort.IC_7K_Crystal_Ball_24BC
...
--   proc_IC_7K_Crystal_Ball_24BC_Append
--   proc_7K_Crystal_Ball_App_AFID_level_24BC_Append   <- this one
--
...
-- IC_7K_Crystal_Ball_24BC ran, CB_User arrives here as 0, the gate
...
-- FROM `variant-finance-data-project.Icarus_Cohort.IC_7K_Crystal_Ball_24BC` s
