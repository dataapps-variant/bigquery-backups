CREATE OR REPLACE TABLE `variant-finance-data-project.LMC.JF_retention_data` AS
WITH 
...
base_data AS (
    -- Step 1: Direct JF retention data
    SELECT 
...
-- Filter to keep only records where first 2 letters of Cohort_Concat = "JF"
