-- =====================================================
-- IC_7K_30D_Crystal_Ball_AFID — INCREMENTAL APPEND
-- Converted from proc_IC_7K_30D_Crystal_Ball_AFID (full rebuild).
--
...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_IC_7K_30D_Crystal_Ball_AFID_Append`()
BEGIN
  ...
  WHERE Report_date >= DATE_SUB(
    (SELECT MAX(Report_date) FROM `variant-finance-data-project.Icarus_Cohort.IC_7K_30D_Crystal_Ball_AFID`),
