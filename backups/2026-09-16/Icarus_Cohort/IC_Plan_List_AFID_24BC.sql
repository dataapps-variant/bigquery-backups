...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_IC_Plan_List_AFID_24BC`()
BEGIN


CREATE OR REPLACE TABLE `variant-finance-data-project.Icarus_Cohort.IC_Plan_List_AFID_24BC` AS
WITH config AS (
...
LEFT JOIN `variant-finance-data-project.Icarus_Cohort.IC_AFID_List_24BC` afid_list
