...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_IC_7K_30D_Main_Table_24BC`()
BEGIN


CREATE OR REPLACE TABLE `variant-finance-data-project.Icarus_Cohort.IC_7K_30D_Main_Table_24BC` AS
...
-- UPDATED: Now uses aggregated_plan_list instead of direct Plan_List
-- =====================================================
...
master_combinations AS (
  ...
  WHERE rd.report_date >= apc.First_Date_of_Sale     -- ✅ ADD THIS LINE
),
-- =====================================================
-- PRODUCT ATTRIBUTES ENRICHMENT
-- UPDATED: Now joins to aggregated_plan_list instead of direct Plan_List
-- =====================================================
enriched_master AS (
  SELECT 
    mc.*,
...
-- =====================================================
-- INITIAL COHORT SELECTION (35K TRANSACTIONS)
-- CHANGED: Product_Name_Final → Product_Name_Final_Merged
-- =====================================================
...
-- CHANGED: Product_Name_Final → Product_Name_Final_Merged (fresh_join)
-- =====================================================
final_cohort AS (
  SELECT 
    ics.report_date,
...
-- =====================================================
-- SINGLE SALE METRICS CALCULATION (NEW)
-- =====================================================
...
-- =====================================================
-- RECENT SPEND CALCULATION (UPDATED: report_date - 6 days to report_date)
-- CHANGED: Product_Name_Final → Product_Name_Final_Merged
-- =====================================================
...
-- =====================================================
-- RECENT USERS CALCULATION (UPDATED: report_date - 6 days to report_date)
-- CHANGED: Product_Name_Final → Product_Name_Final_Merged
-- =====================================================
...
-- UPDATED: Net_ARPU_Discounted now includes SS_Value
-- =====================================================
...
-- =====================================================
-- FINAL OUTPUT - With SS_Users, SS_Value, and Net_LTV_Discounted Columns
-- =====================================================
SELECT 
...
ORDER BY fop.report_date DESC, fop.Product_Name_Final, fop.Country_Code, fop.AFID, fop.billing_cycle;
