...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_IC_AFID_List_24BC`()
BEGIN
...
SET query = FORMAT("""
  CREATE OR REPLACE TABLE `variant-finance-data-project.Icarus_Cohort.IC_AFID_List_24BC` AS
  WITH base AS (
    SELECT
      CASE
