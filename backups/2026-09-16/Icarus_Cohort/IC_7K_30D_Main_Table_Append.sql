-- =====================================================
-- IC_7K_30D_Main_Table — INCREMENTAL APPEND
-- Converted from proc_IC_7K_30D_Main_Table (full rebuild).
--
...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_IC_7K_30D_Main_Table_Append`()
BEGIN
  ...
  WHERE Report_date >= DATE_SUB(
    (SELECT MAX(Report_date) FROM `variant-finance-data-project.Icarus_Cohort.IC_7K_30D_Main_Table`),
  ...
  IF days_to_process > 0 THEN
    ...
    -- =====================================================
    INSERT INTO `variant-finance-data-project.Icarus_Cohort.IC_7K_30D_Main_Table` (
...
calculated_ratios AS (
  ...
  LEFT JOIN `variant-finance-data-project.Icarus_Cohort.IC_Refund_Table` rt
...
-- =====================================================
-- 1. IC_7K_30D_Main_Table must already exist — run the rebuild once.
--
-- 2. IC_Refund_Table must be appended FIRST. calculated_ratios joins
...
--    missing.
--
--      proc_IC_Refund_Table_Append
--      proc_IC_7K_30D_Main_Table_Append   <- this one
--
-- 3. Keep lookback_days aligned with IC_Refund_Table's.
--
--
-- =====================================================
...
-- proc_IC_7K_30D_Main_Table's sibling IC_7K_Main_Table, which
