CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_User_Count_AFID_24BC`()
BEGIN

CREATE OR REPLACE TABLE `variant-finance-data-project.Icarus_Cohort.User_Count_AFID_24BC` AS
WITH base AS (
  SELECT
