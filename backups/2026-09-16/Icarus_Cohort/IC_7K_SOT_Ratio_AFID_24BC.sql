CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_IC_7K_SOT_Ratio_AFID_24BC`()
BEGIN


CREATE OR REPLACE TABLE `variant-finance-data-project.Icarus_Cohort.IC_7K_SOT_Ratio_AFID_24BC` AS
...
-- =====================================================
-- SCRIPT COMPLETE - IC_7K_SOT_Ratio_AFID
-- Table: variant-finance-data-project.Icarus_Cohort.IC_7K_SOT_Ratio_AFID
--
-- GRAIN: Report_date × Product_Name_Final × Country_Code × AFID_Suffix × Billing_Cycle
--
-- AFID_CHANNEL FULLY REMOVED:
-- - No AFID / Channel column in output
-- - No COALESCE(AFID_CHANNEL, 80) anywhere
-- - Base table joins use AFID_Suffix = base.AFID (NULL-safe)
--
-- SOURCE: IC_Plan_List_AFID (AFID_Suffix only, no AFID column)
--
-- OUTPUT COLUMNS (9):
-- Report_date, Product_Name_Final, Country_Code, AFID_Suffix,
