CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_IC_7K_Crystal_Ball_AFID_24BC`()
BEGIN


CREATE OR REPLACE TABLE `variant-finance-data-project.Icarus_Cohort.IC_7K_Crystal_Ball_AFID_24BC` AS
...
sot_ratio_lookup AS (
  ...
  FROM bc_end_date_calculation bedc
  LEFT JOIN `variant-finance-data-project.Icarus_Cohort.IC_7K_SOT_Ratio_AFID_24BC` sot
...
calculated_ratios AS (
  ...
  LEFT JOIN `variant-finance-data-project.Icarus_Cohort.IC_Refund_Table_AFID_24BC` rt
...
-- =====================================================
-- SCRIPT COMPLETE - IC_7K_Crystal_Ball_AFID
--
-- GRAIN: Report_date × Product_Name_Final × Country_Code × AFID_Suffix × Billing_Cycle
-- CONFIG: limiting_days=300, retry_engine_period=1, minimum_rebill_users=25
--
-- SOURCE TABLES:
-- - Plan List: IC_Plan_List_AFID
-- - SOT Ratio: IC_7K_SOT_Ratio_AFID
-- - Refund Table: IC_Refund_Table_AFID
--
