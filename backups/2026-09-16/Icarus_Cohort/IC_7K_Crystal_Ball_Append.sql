-- =====================================================
-- IC_7K_Crystal_Ball — INCREMENTAL APPEND
-- Converted from proc_IC_7K_Crystal_Ball (full rebuild).
--
...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_IC_7K_Crystal_Ball_Append`()
BEGIN
  ...
  WHERE Report_date >= DATE_SUB(
    (SELECT MAX(Report_date) FROM `variant-finance-data-project.Icarus_Cohort.IC_7K_Crystal_Ball`),
  ...
  IF days_to_process > 0 THEN
    ...
    -- =====================================================
    INSERT INTO `variant-finance-data-project.Icarus_Cohort.IC_7K_Crystal_Ball` (
...
sot_ratio_lookup AS (
  ...
  FROM bc_end_date_calculation bedc
  LEFT JOIN `variant-finance-data-project.Icarus_Cohort.IC_7K_SOT_Ratio` sot
...
--   <whatever populates IC_7K_SOT_Ratio>
--   proc_IC_7K_Crystal_Ball_Append   <- this one
--
-- 1. IC_Refund_Table feeds calculated_ratios. If it lags a day,
...
--
-- 2. IC_7K_SOT_Ratio is worse, because SOT_Ratio is a DIVISOR:
...
--    IC_7K_Main_Table gates on clean_rebill_users. Different inputs,
...
-- =====================================================
-- IC_7K_Crystal_Ball must already exist — run the rebuild once to seed
