-- =====================================================
-- IC_7K_Main_Table — INCREMENTAL APPEND
-- Converted from proc_IC_7K_Main_Table (full rebuild).
--
...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_IC_7K_Main_Table_Append`()
BEGIN
  ...
  WHERE Report_date >= DATE_SUB(
    (SELECT MAX(Report_date) FROM `variant-finance-data-project.Icarus_Cohort.IC_7K_Main_Table`),
  ...
  IF days_to_process > 0 THEN
    ...
    -- =====================================================
    INSERT INTO `variant-finance-data-project.Icarus_Cohort.IC_7K_Main_Table` (
...
-- =====================================================
-- 1. IC_7K_Main_Table must already exist — run the rebuild once.
--
...
--      proc_IC_7K_Main_Table_Append   <- this one
--
