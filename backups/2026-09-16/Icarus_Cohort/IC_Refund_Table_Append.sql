...
-- Converted from the optimized full-rebuild proc_IC_Refund_Table.
--
...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_IC_Refund_Table_Append`()
BEGIN
  ...
  WHERE Report_date >= DATE_SUB(
    (SELECT MAX(Report_date) FROM `variant-finance-data-project.Icarus_Cohort.IC_Refund_Table`),
...
-- =====================================================
-- Run the full rebuild proc_IC_Refund_Table ONCE first. This append
...
--   WHERE table_name = 'IC_Refund_Table';
