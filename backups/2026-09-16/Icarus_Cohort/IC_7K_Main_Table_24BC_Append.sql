-- =====================================================
-- IC_7K_Main_Table_24BC — INCREMENTAL APPEND
-- Converted from proc_IC_7K_Main_Table_24BC (full rebuild).
--
...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_IC_7K_Main_Table_24BC_Append`()
BEGIN
  ...
  -- =====================================================
  DELETE FROM `variant-finance-data-project.Icarus_Cohort.IC_7K_Main_Table_24BC`
  WHERE Report_date >= DATE_SUB(
    (SELECT MAX(Report_date) FROM `variant-finance-data-project.Icarus_Cohort.IC_7K_Main_Table_24BC`),
  ...
  IF days_to_process > 0 THEN
    ...
    -- =====================================================
    INSERT INTO `variant-finance-data-project.Icarus_Cohort.IC_7K_Main_Table_24BC` (
...
-- =====================================================
-- 1. IC_7K_Main_Table_24BC must already exist — run the rebuild once.
--
...
--      proc_IC_7K_Main_Table_24BC_Append   <- this one
--
