CREATE PROCEDURE `variant-finance-data-project`.VPU_Merged.proc_15K_Main_Table_MP()
BEGIN

-- =====================================================
-- 15K MAIN TABLE CREATION SCRIPT - MODIFIED VERSION
-- WITH RECENT_CAC (WA Columns Removed)
-- WITH NULL CASCADE (Rebill < 25 = NULL)
-- 
...
-- 5. NEW: Rebill < 25 at ANY BC → Retention_rate = NULL → All metrics = NULL
-- 
...
-- 6. NEW: Added minimum_rebill_users threshold with NULL cascade
-- =====================================================
...
--
-- MODIFICATION 5: NULL CASCADE (NEW)
-- 1. Added minimum_rebill_users = 25 to config
-- 2. Carried minimum_rebill_users through master_combinations and enriched_master
-- 3. Renamed calculated_ratios → base_ratios (with base_ column prefixes)
-- 4. Rewrote retention_step_0 through retention_step_4 with NULL injection and cascade
-- 5. Rewrote final_calculations: all 12 metrics NULL when Retention_rate IS NULL
-- 6. Updated ltv_prep: Net_LTV and Net_LTV_Discounted NULL when Retention_rate IS NULL
-- 7. Changed output column: Minimum_User_count → Minimum_Rebill_Count
--
-- TOTAL CHANGES: 41 (was 34)
-- 
-- OUTPUT COLUMNS: 41
-- =====================================================
