CREATE PROCEDURE `variant-finance-data-project`.VPU_Merged.proc_15K_Main_Table_300()
BEGIN
...
CREATE OR REPLACE TABLE `variant-finance-data-project.VPU_Merged.15K_Main_Table_300` AS
