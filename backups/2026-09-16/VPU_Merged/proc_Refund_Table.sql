CREATE PROCEDURE `variant-finance-data-project`.VPU_Merged.proc_Refund_Table()
BEGIN
...
CREATE OR REPLACE TABLE `variant-finance-data-project.VPU_Merged.Refund_Table` AS
...
config AS (
  SELECT 
    ...
    0.001 AS refund_ratio_threshold,
...
cohort_analysis AS (
  ...
  GROUP BY subq.report_date, subq.Product_Name_Final, subq.billing_cycle, subq.Country_Code
),
