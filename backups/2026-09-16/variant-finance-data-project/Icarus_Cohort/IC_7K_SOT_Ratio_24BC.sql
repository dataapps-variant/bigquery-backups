...
CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_IC_7K_SOT_Ratio_24BC`()
BEGIN


CREATE OR REPLACE TABLE `variant-finance-data-project.Icarus_Cohort.IC_7K_SOT_Ratio_24BC` AS
...
master_combinations AS (
  ...
  WHERE rd.report_date >= pal.First_Date_of_Sale     -- ADDED
),
-- =====================================================
...
-- =====================================================
-- SCRIPT COMPLETE - 7K SOT RATIO PLAN × AFID LEVEL - EXTENDED TO BC24
-- Table: variant-finance-data-project.Icarus_Cohort.IC_7K_SOT_Ratio_24BC
--
...
--   - Uses App_Name (from IC_Plan_List_24BC) for CT prefix detection
-- Cohort: 7,000 per Product_Name_Final + Country_Code + AFID + BC
-- Trial_Type: Blended (NT + non-NT together)
--
-- SOURCE TABLES:
-- 1. Icarus_Cohort.IC_Plan_List_24BC (Plan list + App_Name + Country_Code + AFID)
