CREATE PROCEDURE `variant-finance-data-project`.VPU.proc_15K_Crystal_Ball_MP()
BEGIN

-- =====================================================
-- 15K CRYSTAL BALL TABLE CREATION SCRIPT
...
CREATE OR REPLACE TABLE `variant-finance-data-project.VPU.15K_Crystal_Ball_MP` AS
...
-- =====================================================
-- SCRIPT COMPLETE - 15K CRYSTAL BALL TABLE
-- Table: variant-finance-data-project.VPU.15K_Crystal_Ball
-- 
-- OUTPUT: 55 columns
-- - Removed: Rebill_users, Rebill_value (2)
-- - Added: Day_0_user, Day_0_values, SOT_Ratio, CB_User, CB_Value (5)
-- 
-- KEY CHANGES FROM MAIN TABLE:
-- 1. retry_engine_period = 1 day (vs 30)
