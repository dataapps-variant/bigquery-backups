CREATE OR REPLACE TABLE `variant-finance-data-project.Sticky_Data.Sticky_Order_Maintenance_DT` AS
SELECT 
  Order_Id,
  last_updated,
  Date_of_Sale,
...
FROM `variant-finance-data-project.Sticky_Data.Sticky_data_API_original_DT_V`
