CREATE OR REPLACE VIEW `variant-finance-data-project.Sticky_Data.Sticky_data_API_original_PD_V` AS
...
UNION ALL
  ...
  SELECT
    ...
    prd_offer_id AS Offer_Id,
    cc_first_6 AS BIN
  FROM `variant-finance-data-project.Sticky_Data.hold_orders_PD`
