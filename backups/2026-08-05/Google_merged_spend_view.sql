CREATE OR REPLACE VIEW `variant-finance-data-project.vatiant_finance_Google_Query_Test.Google_merged_final_spend` AS

-- Get all records from the ad_performance based view
SELECT 
    Channel_name,
    Date,
    Channel_type,
