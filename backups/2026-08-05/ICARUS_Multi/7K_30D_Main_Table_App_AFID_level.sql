...
-- =====================================================
-- SCRIPT COMPLETE - 7K 30D MAIN TABLE APP × AFID LEVEL
-- Table: variant-finance-data-project.ICARUS_Multi.7K_30D_Main_Table_App_AFID_level
--
-- GRAIN: Report_date × App_Name × Country_Code × AFID × Billing_Cycle
--
-- SOURCE TABLE:
-- variant-finance-data-project.Icarus_Cohort.IC_7K_30D_Main_Table
--
