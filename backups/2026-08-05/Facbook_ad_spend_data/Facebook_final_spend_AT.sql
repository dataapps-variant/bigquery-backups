CREATE OR REPLACE VIEW `variant-finance-data-project.Facbook_ad_spend_data.Facebook_final_spend_AT` AS
...
country_spend_ranked AS (
  ...
  FROM `variant-finance-data-project.Facbook_ad_spend_data.Facebook_Ads_AT_Country_Code_map` country_map
),
...
SELECT 
  ...
  COALESCE(final.mapped_app_name, 'AT') as App_name,
