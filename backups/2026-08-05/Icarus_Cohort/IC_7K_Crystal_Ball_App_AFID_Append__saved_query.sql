CREATE OR REPLACE PROCEDURE `variant-finance-data-project.Icarus_Cohort.proc_IC_7K_Crystal_Ball_App_AFID_Append`()
BEGIN
-- =====================================================
...
-- =====================================================
DELETE FROM `variant-finance-data-project.Icarus_Cohort.IC_7K_Crystal_Ball_App_AFID`
WHERE Report_date >= DATE_SUB(
  (SELECT MAX(Report_date) FROM `variant-finance-data-project.Icarus_Cohort.IC_7K_Crystal_Ball_App_AFID`),  -- ▼ (2 of 4) ▼
...
IF days_to_process > 0 THEN
  ...
  -- =====================================================
  INSERT INTO `variant-finance-data-project.Icarus_Cohort.IC_7K_Crystal_Ball_App_AFID`
