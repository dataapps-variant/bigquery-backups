CREATE OR REPLACE VIEW `variant-finance-data-project.MS_ad_spend_data.MS_Ads_final_spend_CN` AS
...
ad_performance_with_countries AS (
  ...
  FROM `variant-finance-data-project.MS_ad_spend_data.MS_Ads_CN_AdPerformanceDailyReport` ad
...
SELECT 
  ...
  COALESCE(fem.`App_name`, 'CN') as App_name,
  CASE 
