CREATE PROCEDURE `variant-finance-data-project`.VPU.proc_15K_Main_Table_300()
BEGIN



-- =====================================================
-- 15K MAIN TABLE CREATION SCRIPT - FINAL VERSION
...
CREATE OR REPLACE TABLE `variant-finance-data-project.VPU.15K_Main_Table_300` AS
