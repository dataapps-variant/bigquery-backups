CREATE PROCEDURE `variant-finance-data-project`.Verifications.Verification_41_52_Proc()
BEGIN
-- ============================================================================
...
missing_52 AS (
  SELECT 
    'Decline_Reason_Final' AS missing_in_table,
    ...
    t1.Decline_Reason AS missing_value
  FROM `variant-finance-data-project.Daedalus.Decline_Reason_Final` t1
  WHERE t1.Final_Category IS NULL 
     OR TRIM(t1.Final_Category) = '')
